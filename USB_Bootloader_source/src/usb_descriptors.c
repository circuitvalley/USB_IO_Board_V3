...
ROM USB_DEV_DSC device_dsc=
{
    ...
    0x1209,                 // Vendor ID: Opensource
    0x7778,                 // Product ID: HID Bootloader
...
ROM struct{uint8_t bLength;uint8_t bDscType;uint16_t string[21];}sd001={
sizeof(sd001),DSC_STR,
'w','w','w','.','C','i','r','c','u','i',
't','V','a','l','l','e','y','.','c','o','m'};

//Product string descriptor
ROM struct{uint8_t bLength;uint8_t bDscType;uint16_t string[21];}sd002={
sizeof(sd002),DSC_STR,
'C','V',' ','H','I','D',' ','U','S','B',' ','B','o','o',
't','l','o','a','d','e','r'};

//Product string descriptor
ROM struct{uint8_t bLength;uint8_t bDscType;uint16_t string[14];}sd003={
sizeof(sd003),DSC_STR,
'C','V',' ','U','S','B','O','O','T','F','F','F','F','F'};
